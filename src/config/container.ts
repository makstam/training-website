...
import { PumaRepository } from '../repositories/PumaRepository'; // 🐾 змінив імпорт
...
// Пряме зв'язування конкретного класу PumaRepository як одиночного екземпляру
container.bind(PumaRepository).toSelf().inSingletonScope(); // 🐾 змінив клас
